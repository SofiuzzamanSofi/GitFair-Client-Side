    ...
    return (
        <div className=''>
            ...
            <div className='card-div border-black mx-auto group hover:bg-[#66C555] duration-700 bg-white px-11 py-6'>
                ...
                <button className="btn text-white group-hover:bg-white group-hover:text-[#66C555] bg-[#66C555] rounded-lg border-none uppercase">Explore resources<BsArrowRight className='ml-2  text-xl'></BsArrowRight></button>

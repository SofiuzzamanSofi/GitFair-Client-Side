        ...
        >
            <div className=" lg:w-[1240px] m-auto mt-36 lg:mt-56 md:mt-46 small-display md:px-10 sm:px-10">
                <div className='border-l-8 border-[#66C555] '>
                    <h2 className='text-3xl lg:text-5xl md:text-3xl font-bold px-4 mb-10'>Features Demonstration</h2>
                </div>
                    ...
                    <div className="hero border-solid border-2 rounded-md border-gray-800">
                        <div className="hero-content flex-col lg:flex-row">
                            ...
                            <div className='pt-6 lg:ml-20 lg:pt-0 md:pt-0' data-aos="zoom-in-left">
                                <h1 className="text-3xl lg:text-5xl md:text-3xl font-bold">Code Editor</h1>
                                <p className="py-6">
                    ...
                    <div className="hero my-20 lg:mt-40 border-solid border-2 rounded-md border-gray-800">
                        <div className="hero-content flex-col lg:flex-row-reverse">
                            ...
                            <div data-aos="zoom-in-right" className='pt-6 lg:pt-0 md:pt-0'>
                                <h1 className="text-3xl lg:text-5xl md:text-3xl font-bold">File Upload and Share</h1>
                                <p className="py-6">
                                    ...
                                    <br />
                                    <br />
                                    - This may allow users to upload files of various formats, such as PDFs, images, videos, and text files. Once uploaded, users may be able to set permissions on the files, such as setting them to private or public, and controlling who can access them.
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="hero-content flex-col lg:flex-row-reverse">
                            ...
                            <div data-aos="zoom-in-right" className='pt-6 lg:pt-0 md:pt-0'>
                                ...
                                <p className="py-6">
                                    ...
                                    <br />
                                    <br />
                                    - It also may ensure the security of the original long link and the shortened link, protecting users from phishing or other types of scams.
                                </p>
                            </div>
                        </div>
                    </div>

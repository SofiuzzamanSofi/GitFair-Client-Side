...
const Members = [
  ...
  },
  {
    ...
    portfolio: "https://taimulportfolio.netlify.app/",
  },
  {
    id: 5,
    image: img6,
    ...
    >
      <div className="lg:w-[1240px] m-auto mt-36 lg:mt-56 md:mt-46 small-display md:px-10 sm:px-10">
        <div className="border-l-8 border-[#66C555] ">
          <h2 className="text-3xl lg:text-5xl md:text-3xl font-bold px-4">
            Our Team Members
          </h2>
        </div>
        <div className="grid mx-auto lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 lg:max-w-screen lg:px-10 md:pt-8">
          {Members.map(
            ({ id, image, name, designation, github, linkedin, portfolio }) => (
              <div
                key={id}
                className="py-6 lg:py-14 md:py-10"
                data-aos="fade-left"
        ...
        <div className="my-16 lg:mb-96 lg:pb-12 md:my-24 md:pb-16">
              ...
              <div className="relative group">
                ...
                <button className="relative px-7 py-6 md:py-6 text-lg lg:text-2xl rounded-2xl leading-none flex items-center divide-x divide-slate-800">
                  <span className="flex items-center space-x-5">
                    <span className="pr-6 text-slate-100 font-semibold">
                      GitFair Like As Globe For Developers
                    </span>
                  </span>
          ...
          <img
            src={globe}
            alt="Globe"
            className="absolute w-full rounded-2xl right-2"
          />
          <img
            src={astrocat}
            alt="Astrocat"
            className="relative w-1/3 left-28 top-6 lg:top-96 lg:left-96 md:top-36 md:left-56 pt-28"
          />
        </div>
      </div>
    </div>
